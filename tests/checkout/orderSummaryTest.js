...
describe('test suite: render order summary', () => {
  ...
  it('displays the cart', () => {
    ...
    expect(document.querySelector(`.js-product-name-${productId1}`).innerHTML).toContain('Black and Gray Athletic Cotton Socks - 6 Pairs');

    expect(document.querySelector(`.js-product-name-${productId2}`).innerHTML).toContain('Intermediate Size Basketball');
  ...
  it('updates delivery option', () => {
    ...
    expect(document.querySelector('.js-shipping-summary-price').innerText).toEqual('$14.98');

    expect(document.querySelector('.js-total-price-summary').innerText).toEqual('$63.50');
